...
/**********************************************************************************************************************/
    ...
    public function generateBreadcrumbs() {
        ...
        switch( $currentType ) {
			...
			case ffConstQuery::HOME:
				$this->_generateBreadcrumbsForPostsPage();
				break;
...
/**********************************************************************************************************************/
	...
	private function _generateBreadcrumbsForPostsPage() {
		...
		$postsPageId = $page_for_posts = get_option( 'page_for_posts' );
		$postsPage = get_post( $postsPageId );

		$breadcrumbItem->name = $postsPage->post_title;
		$breadcrumbItem->type = 'posts_page';
		$breadcrumbItem->url = get_permalink( $postsPageId );
		$breadcrumbItem->queryType = ffConstQuery::POSTS_PAGE;
...
/**********************************************************************************************************************/
    private function _createBreadcrumbFromTerm( $term ) {
        ...
        if( empty( $term->term_id ) or empty( $term->taxonomy ) ) {
            $breadcrumbItem->url = '';
        }else{
