...
class ffOneOption extends ffBasicObject implements ffIOneDataNode {
	...
	const TYPE_TEXTAREA_STRICT = 'textarea_strict';
	const TYPE_NUMBER = 'number';
	const TYPE_RADIO = 'radio';
	const TYPE_FONT = 'font';
	const TYPE_SELECT = 'select';
    const TYPE_SELECT_FRESH = 'select_fresh';
    const TYPE_SELECT_STYLES = 'select_styles';
	...
	const TYPE_GFONT_SELECTOR = 'gfont_selector';
	...
	const TYPE_COLOR_PICKER_WITH_LIB = 'color_picker_with_lib';
	const TYPE_TINYMCE = 'tinymce';
	const TYPE_HIDDEN = 'hidden';
	const TYPE_OPTIONS_COLLECTION = 'options_collection';
	const TYPE_SIDEBAR_SELECTOR = 'sidebar_selector';

    const TYPE_COLOR_PICKER_FRONT = 'color_picker_front';

    const TYPE_BOX_MODEL= 'box_model';

    const TYPE_NUMBER_SLIDER = 'number_slider';

	const PARAM_TITLE_AFTER = 'PARAM_TITILE_AFTER';
	const PARAM_HIDING_BOX = 'hiding_box';
	const PARAM_CODE_EDITOR = 'code_editor';
