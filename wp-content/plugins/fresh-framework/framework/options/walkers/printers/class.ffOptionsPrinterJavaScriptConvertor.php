...
class ffOptionsPrinterJavaScriptConvertor extends ffOptionsWalker {
	...
	protected $_printCopyAndPaste = true;
	...
	public function setPrintCopyAndPaste( $value ) {
		$this->_printCopyAndPaste = $value;
	}
...
//        var_dump( $this->_data );
    ...
    public function walk() {
	    ...
	    $dataPrintCopyAndPaste = $this->_printCopyAndPaste ? '' : 'data-print-copy-and-paste="false"';

        $toReturn = '';
        $toReturn .= '<div class="ff-options-js-wrapper '.$wrapperClass.'" '.$dataPrintCopyAndPaste.'>';
