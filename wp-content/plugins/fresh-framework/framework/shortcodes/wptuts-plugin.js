    ...
    tinymce.create('tinymce.plugins.Wptuts', {
        ...
        init : function(ed, url) {
        	...
        	ed.on( 'BeforeSetContent', function( e ) {
        		e.content = e.content.replace('UUUUUU', '<div style="background-color:red">UUUUUU</div>');
        		/*
        		if ( e.content ) {
        	...
        	ed.on( 'PostProcess', function( e ) {
        		e.content = e.content.replace('<div style="background-color:red">UUUUUU</div>', 'UUUUUU');
        		/*
        		if ( e.get ) {
