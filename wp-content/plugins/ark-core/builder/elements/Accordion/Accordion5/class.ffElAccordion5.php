...
/**
 * @link http://demo.freshface.net/html/h-ark/HTML/page_faq_modern.html#scrollTo__550
 */

class ffElAccordion5 extends ffElAccordion2 {

	protected function _initData() {
		$this->_setData( ffThemeBuilderElement::DATA_ID, 'accordion-5');
		$this->_setData( ffThemeBuilderElement::DATA_NAME, esc_attr( __('Accordion 5', 'ark' ) ) );
	...
	protected function _render( ffOptionsQueryDynamic $query, $content, $data, $uniqueId ) {
		...
		$this->_renderBasicElement($query, $content, $data, $uniqueId, 5);
