...
class ffElAlert3 extends ffThemeBuilderElementBasic {
	protected function _initData() {
		$this->_setData( ffThemeBuilderElement::DATA_ID, 'alert-3');
		$this->_setData( ffThemeBuilderElement::DATA_NAME, esc_attr( __('Alert 3', 'ark' ) ) );
	...
	protected function _getElementGeneralOptions( $s ) {
		...
		$s->addOptionNL( ffOneOption::TYPE_COLOR_PICKER_WITH_LIB, 'bg-color', '', '#e55973')
	...
	protected function _render( ffOptionsQueryDynamic $query, $content, $data, $uniqueId ) {
		...
		foreach( $query->get('content') as $oneItem ) {
			switch ($oneItem->getVariationType()) {
				...
				case 'description':
					$this->_renderCSSRule( 'color', $oneItem->getColor('color') );
					$this->_renderCSSRule( 'color', $oneItem->getColor('color'), ' p' );
