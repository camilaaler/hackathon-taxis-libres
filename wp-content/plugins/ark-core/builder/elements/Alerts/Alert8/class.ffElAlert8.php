...
class ffElAlert8 extends ffThemeBuilderElementBasic {
	protected function _initData() {
		$this->_setData( ffThemeBuilderElement::DATA_ID, 'alert-8');
		$this->_setData( ffThemeBuilderElement::DATA_NAME, esc_attr( __('Alert 8', 'ark' ) ) );
	...
	protected function _getElementGeneralOptions( $s ) {
		...
		$s->addElement( ffOneElement::TYPE_TABLE_START );
			...
			$s->addElement( ffOneElement::TYPE_TABLE_DATA_START, '', ark_wp_kses( __('Icon', 'ark' ) ) );
				...
				;
				$s->addOptionNL( ffOneOption::TYPE_COLOR_PICKER_WITH_LIB, 'icon-bg-color', '', '#536dfe')
			...
			$s->addElement( ffOneElement::TYPE_TABLE_DATA_START, '', ark_wp_kses( __('Content', 'ark' ) ) );
				...
				$s->startRepVariableSection('content');
					...
					$s->startRepVariationSection('title', ark_wp_kses( __('Title', 'ark' ) ) );
						...
						;
						$s->addOptionNL( ffOneOption::TYPE_COLOR_PICKER_WITH_LIB, 'color', '', '#536dfe')
