...
class ffElSingleProductExcerpt extends ffThemeBuilderElementBasic {
	protected function _initData() {
		$this->_setData( ffThemeBuilderElement::DATA_ID, 'woocommerce-single-product-excerpt');
		$this->_setData( ffThemeBuilderElement::DATA_NAME, 'WC - Single - Short Description');
	...
	protected function _renderContentInfo_JS() {
		...
		<script data-type="ffscript">
			function ( query, options, $elementPreview, $element ) {
				query.addPlainText('WooCommerce - Single Product Short Description');
				query.addBreak();
