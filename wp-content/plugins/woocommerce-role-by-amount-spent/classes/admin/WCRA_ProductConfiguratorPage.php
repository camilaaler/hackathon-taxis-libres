<?php 
class WCRA_ProductConfiguratorPage
{
	
	public static $page_id = "role-o-matic_page_acf-options-products-configurator";
	public static $page_url_par = "acf-options-products-configurator";
	...
	function init_options_menu()
	{
		if( function_exists('acf_add_options_page') ) 
		{
			acf_add_options_sub_page(array(
				'page_title' 	=> 'Products Configurator',
				'menu_title'	=> 'Products configurator',
	...
	function cl_set_global_options_pages($current_screen) 
	{
	  ...
	  $page_ids = array(
		WCRA_ProductConfiguratorPage::$page_id
	  );
